    ...
    <div className="bg-gris w-full h-screen flex flex-row justify-between gap-5">
      ...
      <div className="flex flex-col w-full h-full divide-y divide-gristexto">
        ...
        <div className="w-full h-14 flex items-center gap-2">
          ...
          <button onClick={(e) => handleSimulateAll(e)} value="simular octavos">
            simular octavos
          </button>
          <button onClick={(e) => handleSimulateAll(e)} value="simular cuartos">
            simular cuartos
          </button>
          <button
          ...
          <button onClick={(e) => handleSimulateAll(e)} value="reiniciar">
            reiniciar
          </button>
        </div>
