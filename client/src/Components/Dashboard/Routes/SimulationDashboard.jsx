...
export const Simulation = () =>{
    ...
    function handleSimulateAll(e){
        ...
        if(e.target.value === 'cargar octavos'){
            ...
            axios.put('https://qatarbets-backend-production-ab54.up.railway.app/fixture/finalStageAllSimulation?sim=simulate')
        }
    }
        ...
        <div className="bg-gris w-full h-screen flex flex-row justify-between gap-5">
            ...
            <div className="flex flex-col w-full h-full divide-y divide-gristexto">
                ...
                <div className="w-full h-14 flex items-center gap-2">
                    ...
                    <button onClick={(e)=> handleSimulateAll(e)} value='v'>simular fase de grupos </button>
                    <button onClick={(e)=> handleSimulateAll(e)} value='cargar octavos' >cargar octavos </button>
                    <button onClick={(e)=> handleSimulateAll(e)} value='simular octavos' >simular octavos </button>
                    <button onClick={(e)=> handleSimulateAll(e)} value='simular cuartos' >simular cuartos </button>
                    <button onClick={(e)=> handleSimulateAll(e)} value='simular semifinal' >simular semifinal </button>
                    <button onClick={(e)=> handleSimulateAll(e)} value='simular final' >simular final </button>
