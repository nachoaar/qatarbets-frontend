...
export const Groups = (props) => {
  return (
    <div className="flex flex-col bg-morado bg-opacity-40 backdrop-blur rounded-tr-3xl rounded-bl-3xl rounded-br-md rounded-t-md w-full p-2 sm:w-80 text-blanco pl-6 pr-6">
