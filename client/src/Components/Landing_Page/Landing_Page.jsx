...
export const Landing_Page = () => {
  return (
    <div className="h-screen flex flex-col justify-between">
      <Navbar />
      <div className="bg-soccerPlayers  bg-cover flex flex-col items-center justify-center h-full bg-center">
      ...
      <div className="bg-footer w-screen sm:flex items-center ">
        ...
        <div className=" right-full mx-auto px-4">
          <div className="font-sans text-mikeWhite text-3xl ">CUENTA REGRESIVA PARTIDO INAUGURAL</div>
        </div>
