...
export const setSimulated = (toDo, id) =>{
    return async function(dispatch){
         await axios.put(`https://qatarbets-backend-production-ab54.up.railway.app/fixture/matchSimulation?sim=${toDo}&id=${id}`)
        const simulatedMatch = await axios.get(`https://qatarbets-backend-production-ab54.up.railway.app/fixture/${id}`)
...
export const makeAbsoluteSimulation = () =>{
    return async function(dispatch){
        await axios.put('https://qatarbets-backend-production-ab54.up.railway.app/fixture/groupsSimulation?sim=simulate')
        let payload = await axios.get('https://qatarbets-backend-production-ab54.up.railway.app/fixture/get')
...
export const resetAllMatches = () =>{
    return async function(dispatch){
        await axios.put('https://qatarbets-backend-production-ab54.up.railway.app/fixture/groupsSimulation?sim=reset')
        let payload = await axios.get('https://qatarbets-backend-production-ab54.up.railway.app/fixture/get')
